...
5. Choose a Debrid service for caching the torrents, create an account on it, buy a subscription, and get the API key.
   ...
   * *I use mainly* [***TorBox***](https://torbox.app/subscription?referral=210d0e72-2018-4628-ab7d-4f92f09bc2e7), as a backup I use [***Real-Debrid***](http://real-debrid.com/?id=12639093) *(these are referral links since we're at it :), two of the best platforms, with the best prices and very stable.* **DON'T USE REAL-DEBRID FOR NOW, IT'S HAVING LEGAL ISSUES, PROCEED WITH TORBOX.**
